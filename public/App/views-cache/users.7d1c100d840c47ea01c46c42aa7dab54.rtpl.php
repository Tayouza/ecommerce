                ...
                <tbody class="overflow-auto">
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="/admin/users/delete/<?php echo htmlspecialchars( $value1["iduser"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" onclick="return confirm('Deseja realmente excluir este registro?')" class="btn btn-danger btn-xs"><i class="fa fa-edit"></i>Excluir</a>
                    </td>
                  </tr>
                  <?php } ?>
                </tbody>
