                                ...
                                <div class="col-md-12">
                                    <div class="woocommerce-billing-fields">
                                        ...
                                        <p id="billing_address_1_field"
                                            ...
                                            <input type="text" value="" placeholder="00000-000" id="billing_address_1"
                                        ...
                                        <p id="billing_address_1_field"
                                            ...
                                            <input type="text" value="" placeholder="Logradouro, número e bairro"
                                                id="billing_address_1" name="billing_address_1" class="input-text ">
                                        </p>

                                        <p id="billing_address_2_field" class="form-row form-row-wide address-field">
                                            <input type="text" value="" placeholder="Complemento (opcional)"
                                        ...
                                        <p id="billing_state_field"
                                            ...
                                            <input type="text" id="billing_state" name="billing_state"
                                                placeholder="Estado" value="" class="input-text ">
                                        </p>
                                        ...
                                        <p id="billing_state_field"
                                            ...
                                            <input type="text" id="billing_state" name="billing_state"
                                                placeholder="País" value="" class="input-text ">
                                        </p>
